...
class CreateLivresTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('livres', function (Blueprint $table) {
            ...
            $table->string('titre');
            $table->enum('genre', ['Action', 'Drame', 'Romance', 'Science-fiction', 'Mystère', 'Thriller', 'Fantaisie', 'Aventure', 'Horreur', 'Dystopie', 'Humour', 'Jeunesse', 'Biographie', 'Histoire', 'Sciences naturelles', 'Sciences sociales', 'Psychologie', 'Économie', 'Politique', 'Religion']);
